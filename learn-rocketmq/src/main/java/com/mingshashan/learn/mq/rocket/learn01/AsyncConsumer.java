...
public class AsyncConsumer {
    public static void main(String[] args) throws MQClientException {
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer(MQConstant.SIMPLE_CONSUMER_GROUP);

        consumer.setNamesrvAddr(MQConstant.NAME_SRV_ADDR);

        consumer.setMessageModel(MessageModel.CLUSTERING);
        consumer.setConsumeTimeout(100000000);
        consumer.setConsumeFromWhere(ConsumeFromWhere.CONSUME_FROM_FIRST_OFFSET);
        consumer.subscribe(MQConstant.SIMPLE_TOPIC, "*");
        ...
        consumer.start();
        System.out.println("SIMPLE Producer start");
    }
