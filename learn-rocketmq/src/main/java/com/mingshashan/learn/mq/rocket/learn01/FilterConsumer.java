...
public class FilterConsumer {
    ...
    public static void main(String[] args) throws MQClientException {
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer(MQConstant.FILTER_CONSUMER_GROUP);

        consumer.setNamesrvAddr(MQConstant.NAME_SRV_ADDR);

        // consumer.setMessageModel(MessageModel.CLUSTERING);
        consumer.setConsumeFromWhere(ConsumeFromWhere.CONSUME_FROM_FIRST_OFFSET);
//        consumer.subscribe(MQConstant.FILTER_TOPIC, MQConstant.FILTER_TAG_E + " || " +
//                MQConstant.FILTER_TAG_F);

        consumer.subscribe(MQConstant.FILTER_TOPIC, MQConstant.FILTER_TAG_F);
        ...
        consumer.start();
        System.out.println("FILTER Producer start");
    }
