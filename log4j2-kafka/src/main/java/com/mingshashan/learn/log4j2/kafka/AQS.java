package com.mingshashan.learn.log4j2.kafka;
...
public class AQS
     ...
     */
    private static boolean shouldParkAfterFailedAcquire(AQS.Node
                                                                pred, AQS.Node node) {
     ...
     */
    private final boolean compareAndSetTail(AQS.Node expect, AQS.Node
            update) {
