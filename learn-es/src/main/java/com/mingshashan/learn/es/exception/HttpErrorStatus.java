...
/**
 * Http 异常响应状态码定义枚举类
 * <br>枚举值定义是拷贝自org.springframework.http.HttpStatus类，HttpStatus.xxx.value()==HttpErrorCode.xxx.value();
 *
 * @author jasonxu
 */
public enum HttpErrorStatus implements ErrorCoded {
    ...
    HttpErrorStatus(int codeValue, String reasonPhrase) {
     ...
     */
    public static HttpErrorStatus valueOf(int statusCode) {
